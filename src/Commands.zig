...
pub const Command = enum (c_int) {
    ...
    ID_PRINT = df.ID_PRINT,
    ID_PRINTSETUP = df.ID_PRINTSETUP,
    ID_DOS = df.ID_DOS,
    ID_EXIT = df.ID_EXIT,
    // --------------- Edit menu ----------------
    ID_UNDO = df.ID_UNDO,
    ...
    ID_PRINTERPORT = df.ID_PRINTERPORT,
    ID_LEFTMARGIN = df.ID_LEFTMARGIN,
    ID_RIGHTMARGIN = df.ID_RIGHTMARGIN,
    ID_TOPMARGIN = df.ID_TOPMARGIN,
    ID_BOTTOMMARGIN = df.ID_BOTTOMMARGIN,
    // ----------- InputBox dialog box ------------
